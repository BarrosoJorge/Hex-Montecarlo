...
#define COL_HEX_BORDER  0x000000FF 
...
void gui_init(const char* title) {
    ...
    // Iniciamos centrado
    window = SDL_CreateWindow(title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1024, 768, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
